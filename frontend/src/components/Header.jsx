...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-[#5f6fff] rounded-lg px-6 md:px-10 lg:px-17'>
      {/* --------------Left Side----------------- */}
      <div className='md:w-1/2 flex flex-col items-start justify-center gap-5 py-10 m-auto md:py-[10vw] md:mb-[-30px]'>
        ...
        <div className='flex items-center gap-3 text-white text-[12.5px] font-light'>
